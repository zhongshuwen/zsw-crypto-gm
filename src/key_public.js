...
/**
  ...
  @param {string} [pubkey_prefix = 'ZSW']
*/
function PublicKey(Q, pubkey_prefix = 'ZSW') {
    if(typeof Q === 'string') {
     ...
     * @arg {string} [pubkey_prefix = 'ZSW'] - public key prefix
    */
    function toString(pubkey_prefix = 'ZSW') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'ZSW']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'ZSW') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'ZSW') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'ZSW') {
