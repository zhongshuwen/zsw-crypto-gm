...
function PrivateKey(d) {
    ...
    */
    function getChildKey(name) {
      // console.error('WARNING: getChildKey untested against zswd'); // no zswd impl yet
...
/**
    ...
    @arg {string} privateStr 中数文 or Wallet Import Format (wif) -- a secret
*/
...
function unitTest() {
  ...
  assert.equal(pub.toString(), 'ZSW859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM', pubError)
  // assert.equal(pub.toString(), 'PUB_K1_859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2Ht7beeX', pubError)
  // assert.equal(pub.toStringLegacy(), 'ZSW859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM', pubError)
