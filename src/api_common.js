...
ecc.randomKey().then(privateKey => {
  ...
  console.log('Public Key:\t', ecc.privateToPublic(privateKey)) // ZSWkey...
    ...
    */
    privateToPublic: (wif, pubkey_prefix = 'ZSW') =>
      PrivateKey(wif).toPublic().toString(pubkey_prefix),

    /**
        @arg {pubkey} pubkey - like ZSWKey..
        @arg {string} [pubkey_prefix = 'ZSW']

        @return {boolean} valid

        @example ecc.isValidPublic(pubkey) === true
    */
    isValidPublic: (pubkey, pubkey_prefix = 'ZSW') =>
    ...
    */
    ...
    /**
        ...
        @arg {String|Buffer} signature (ZSWbase58sig.., Hex, Buffer)
